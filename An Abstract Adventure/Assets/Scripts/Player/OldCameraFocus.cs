...
public class OldCameraFocus : MonoBehaviour
{
    ...
    private OldCameraFollow cameraFollow;
    private OldPlayerMain[] playerMain;

    void Awake()
    {
        cameraFollow = FindObjectOfType<OldCameraFollow>();
        playerMain = FindObjectsOfType<OldPlayerMain>();
    }
